...
\begin{quote}
Given a logical agentic workflow or observed agent trajectory and explicit constraints, produce the best measurable execution plan or reuse decision and evidence for why it is acceptable.
\end{quote}
