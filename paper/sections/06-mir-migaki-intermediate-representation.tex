...
\mir{} is not a prompt format. It is not a JSON wrapper around chat completions. It is a logical representation of AI execution. A trajectory graph is not a full observability product. It is the minimum reusable graph needed to compare runs and reason about exact repeated work.
